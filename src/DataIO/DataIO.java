...
public interface DataIO {
	public static String instance = "03";
	public static String fileName = "testInstance/ParticipantsSuite/ORTEC_TEST_" + instance + ".txt";
	...
	// "testInstance/ParticipantsSuite/VeRoLog_r100d5_2.txt";
	// public static String title = "DATASET = All time best instance set
	// VeRoLog competition" + "\n"
	// + "NAME = tools over distance over vehicle days over vehicles with 100
